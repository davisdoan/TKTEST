...
export class Question {
  ...
  constructor(public navCtrl: NavController, public navParams: NavParams) {
    for(let singleQuestion of apiQuestions){ // loop through the questions list
      if(!this.questions[singleQuestion.Question_Number -1]) // 1st would be:     if not this.questions[0]
        this.questions[singleQuestion.Question_Number -1 ] = {} // set it to ... empty?
